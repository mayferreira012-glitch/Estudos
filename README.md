...
Este portfólio tem o objetivo de registrar e apresentar os projetos que venho desenvolvendo ao longo dessa transição, com foco em SQL, Power BI e Python, aplicando e aprofundando meus conhecimentos em análise, modelagem e visualização de dados.
